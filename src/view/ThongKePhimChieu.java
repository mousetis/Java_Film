...
public class ThongKePhimChieu extends JPanel{
	...
	public ThongKePhimChieu() {
		...
		//Field chọn tên phim từ danh sách tên phim của combox
		boxLeft2.add(Box.createVerticalStrut(20));
		Box boxTenPhim = new Box(BoxLayout.X_AXIS);
		boxTenPhim.add(lbTenPhim = new JLabel("Tên phim:"));
		lbTenPhim.setFont(font);
		cboTenPhim = new JComboBox<>();
//		for(Phim p: ds.layPhim()) {
//			cboTenPhim.addItem(p.getTenPhim());
//		}
		boxTenPhim.add(cboTenPhim);
		boxLeft2.add(boxTenPhim);
		boxLeft2.add(Box.createVerticalStrut(20));
		...
		boxRight1.add(lbTitle2 = new JLabel("BẢNG THỐNG KÊ DOANH THU THEO PHIM"));
